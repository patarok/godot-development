---
id: TASK-0004.03
title: UserRole-Phantom-Code bereinigen (gemäß Evaluierung TASK-0004.02)
status: To Do
assignee: []
created_date: '2026-08-26 13:31'
labels:
  - db
  - auth
  - refactor
...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Cannot find name 'UserRole'-Fehler in authService.ts verschwunden
- [ ] #2 assignRoleToUser entweder entfernt ODER korrekt auf Basis der Peter-Entscheidung nachgerüstet
- [ ] #3 ungenutzter Import in register/+page.server.ts bereinigt
- [ ] #4 svelte-check ohne neue Fehler; App bootet HTTP 200
<!-- AC:END -->
