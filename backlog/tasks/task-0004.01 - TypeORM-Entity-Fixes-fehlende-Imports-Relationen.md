---
id: TASK-0004.01
title: TypeORM-Entity-Fixes (fehlende Imports/Relationen)
status: To Do
assignee: []
...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 datasource.ts: nicht existenter UserRole-Import entfernt
- [ ] #2 ContractorMail-Importpfad korrigiert
- [ ] #3 SubRole-Entities im entities-Array registriert
- [ ] #4 User/Role/SubRole-Relations-Inversen korrigiert
- [ ] #5 Deadline/DeadlineTag-Importpfade + /serve-Typo behoben
<!-- AC:END -->
