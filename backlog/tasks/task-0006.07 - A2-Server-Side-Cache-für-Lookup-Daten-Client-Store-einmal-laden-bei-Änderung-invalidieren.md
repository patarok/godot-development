...
id: TASK-0006.07
title: >-
  A2: Server-Side-Cache für Lookup-Daten + Client-Store (einmal laden, bei
  Änderung invalidieren)
status: In Progress
assignee: []
created_date: '2026-08-28 08:54'
updated_date: '2026-08-28 17:47'
labels:
  - frontend
  - backend
  - perf
...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Lookup-Daten (projects/priorities/states/users/types/metaTasks) server-seitig gecacht und nur bei Änderung refreshed
- [ ] #2 Client-Store hält Lookups vor; invalidate bei Mutation statt reload
- [ ] #3 keine Rederivierung-Schleifen; Memoisierung wo nötig
<!-- AC:END -->
