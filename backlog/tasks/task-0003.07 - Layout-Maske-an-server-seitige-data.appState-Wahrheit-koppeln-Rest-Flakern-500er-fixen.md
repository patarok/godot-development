...
id: TASK-0003.07
title: >-
  Layout-Maske an server-seitige data.appState-Wahrheit koppeln
  (Rest-Flakern/500er fixen)
status: In Progress
assignee: []
created_date: '2026-08-26 14:13'
updated_date: '2026-08-26 14:13'
labels:
  - frontend
  - perf
milestone: m-2
...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Layout-Branch entscheidet Maske anhand data.appState (Cookie), nicht client-only appState.current
- [ ] #2 Hartner Refresh auf /tasks zeigt Maske sofort, kein 'Liste-dann-Maske-dann-weg'
- [ ] #3 Kein 500er mehr auf /tasks (mit eingeloggter Session)
