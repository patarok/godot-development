---
id: TASK-0005.01
title: Stub-Routen vervollständigen (documents/log/projects/mail)
status: To Do
assignee: []
...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 /admin/documents, /admin/log, /admin/projects funktional (kein 🚧-Stub)
- [ ] #2 Mail-Endpunkte vollständig implementiert
- [ ] #3 🚧-Marker aus Sidebar/Menubar entfernt
<!-- AC:END -->
