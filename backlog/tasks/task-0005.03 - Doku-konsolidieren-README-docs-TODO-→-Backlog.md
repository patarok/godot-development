---
id: TASK-0005.03
title: Doku konsolidieren (README/docs/TODO → Backlog)
status: To Do
assignee: []
...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 TODO.md/BATTLEPLAN.md/kanban-todo.md-Inhalte ins Backlog überführt
- [ ] #2 README auf aktuellen Zustand
- [ ] #3 docs/seeding.md, docs/architecture.md angelegt
<!-- AC:END -->
