---
id: TASK-0002.01
title: Kanban Drag&Drop Persistenz (moveCard/updateCard/addCard)
status: To Do
assignee: []
...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 onCardMove im Weekday-View aktualisiert plannedStartDate in DB
- [ ] #2 onCardMove im Status-View aktualisiert taskStatus in DB
- [ ] #3 onCardUpdate speichert Titel/Beschreibung
- [ ] #4 onCardAdd erstellt Task in Spalte
- [ ] #5 Optimistic UI + Rollback bei Fehler
<!-- AC:END -->
