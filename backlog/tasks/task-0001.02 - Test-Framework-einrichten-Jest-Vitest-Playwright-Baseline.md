---
id: TASK-0001.02
title: Test-Framework einrichten (Jest/Vitest + Playwright-Baseline)
status: To Do
assignee: []
...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 npm run test führt tatsächlich Tests aus (kein 'no test specified')
- [ ] #2 Mindestens ein Smoketest der Kern-Routen grün
- [ ] #3 Playwright-E2E-Grundgerüst läuft
<!-- AC:END -->
