...
id: TASK-0006.02
title: >-
  CQRS konsequent durchsetzen: Routes über Query-Models statt direkter
  Repo-Zugriffe
status: To Do
assignee: []
...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 tasks/+page.server.ts und +layout.server.ts nutzen die bestehenden Domain-/Query-Models statt AppDataSource.getRepository(X).find
- [ ] #2 Command-Seite (create/update) nur bei Mutationen aktiv
<!-- AC:END -->
