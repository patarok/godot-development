...
<div class={cn("flex flex-col gap-6", className)} {...restProps}>
    <Card.Root>
        <Card.Header class="text-center">
            <Card.Title class="text-xl">&iquest;Forgot&quest;</Card.Title>
            <Card.Description>request password reset</Card.Description>
        </Card.Header>
            ...
            >
                <div class="grid gap-6">
                    <div class="after:border-border relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t">
                        <span class="bg-card text-muted-foreground relative z-10 px-2">enter email address</span>
                    </div>
                    <div class="grid gap-6">
                    ...
                    <div class="flex flex-row gap-4">
                        <div class="mx-auto">
                        <Button type="button" variant="ghost" class="">
                            <!-- Apple icon -->
