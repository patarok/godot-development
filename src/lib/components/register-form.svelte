                ...
                <div class="grid gap-6">
                    ...
                    <div class="grid gap-6">
                        <div class="grid gap-3">
                            <Label for="email-{uid}">Forename</Label>
                            <Input id="email-{uid}" name="forename" type="text" placeholder="Max" required />
                        </div>
                        <div class="grid gap-3">
                            <Label for="email-{uid}">Surname</Label>
                            <Input id="email-{uid}" name="surname" type="text" placeholder="Smith" required />
                        </div>
                        <div class="grid gap-3">
                            <div class="flex items-center">
                                <Label for="password-{uid}">Username</Label>
                                <span class="ml-auto text-sm underline-offset-4 hover:underline">...is email if not given</span>
                            </div>
                            <Input id="password-{uid}" name="username" type="text" required />
                        </div>
                        <div class="grid gap-3">
