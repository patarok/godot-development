...
export async function seedInitialData() {
    ...
    const passwordHash = process.env.ADMIN_PASSWORD_HASH ?? (await argon2hash(rawPassword, { algorithm: argon2id, memoryCost: 19456, timeCost: 2, outputLen: 32, parallelism: 1 }));
