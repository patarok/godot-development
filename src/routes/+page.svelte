...
<div class={cn("grid place-items-center min-h-screen mx-auto gap-6")}>
    <div class="grid gap-6 w-full max-w-md">
        <Card.Root class="w-full flex flex-col">
            <Card.Header class="w-full">
                <small class="mx-auto">welcome to:</small>
            </Card.Header>
            <Card.Content class="flex flex-col"t>
                <h1 class="mx-auto text-8xl mb-6">GODOT</h1>
    ...
    C2265.103,946.877,2385.634,802.91,2385.265,632.288z"/>
                ...
                <h2 class="mx-auto text-4xl text-center mt-8">Project <br />-<br />MGMT</h2>
